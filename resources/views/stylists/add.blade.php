    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                <div class="p-2">
                    <form method="POST" action="{{ route('store_stylist') }}">
                        @csrf
                        <div>
                        ...
                        <div class="mt-4">
                            ...
                            <x-input id="speciality" class="block mt-1 w-full" type="text" name="speciality" required autofocus />
                        </div>
